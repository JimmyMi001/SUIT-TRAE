...
app.get('/api/poi/nearby', async (req, res) => {
  try {
    ...
    const amapTypeMap = {
      '美食':'餐饮服务','咖啡':'餐饮服务','奶茶':'餐饮服务','甜品':'餐饮服务',
...
/* ==================================================================
 * 🌟 当地特色饮品 & 特色美食 数据库
 * 数据来源：本地知识库 + 大众点评/美团/小红书/抖音口碑
 * 死规矩：所有地点名/店铺名/菜品名均为真实可查
 * ================================================================== */
const LOCAL_SPECIALS_DB = {
  '广州': {
    drinks: [
      { name: '广式糖水', desc: '双皮奶/姜撞奶/杨枝甘露/椰汁西米露/绿豆沙', shops: '南信牛奶甜品世家、玫瑰甜品、百花甜品', why: '广州人夏天必喝的消暑甜品，顺德传统工艺，奶香浓郁' },
      { name: '广式凉茶', desc: '癍痧/廿四味/夏桑菊/五花茶/罗汉果', shops: '黄振龙凉茶、邓老凉茶、耕田公凉茶', why: '广州人"上火"必喝，百年老字号凉茶铺随处可见' },
      { name: '茶理宜世', desc: '招牌江南烟雨/月下桂花酿/胭脂', shops: '茶理宜世（江南西店/北京路店）', why: '广州本土新式茶饮，结合广式文化元素，年轻人必打卡' }
    ],
    foods: [
      { name: '广式早茶', desc: '虾饺/烧卖/凤爪/肠粉/叉烧包/蛋挞/糯米鸡/排骨', why: '广州人"一盅两件"的早茶文化，全国闻名，广州酒家/点都德/陶陶居都是老字号' },
      { name: '白切鸡', desc: '清远鸡/文昌鸡/葱油鸡/豉油鸡', why: '广州人待客必备，皮爽肉滑，原汁原味' },
      { name: '肠粉', desc: '鲜虾肠/牛肉肠/斋肠/炸两/猪肝肠', why: '广州早餐灵魂，银记肠粉是百年老字号' },
      { name: '烧腊', desc: '叉烧/烧鹅/烧肉/烧鸭/油鸡', why: '广州人"斩料加餸"的首选' },
      { name: '云吞面', desc: '鲜虾云吞/净云吞/捞面', why: '广州地道面食' }
    ]
  },
  '北京': {
    drinks: [
      { name: '豆汁儿', desc: '老北京豆汁儿配焦圈/咸菜', shops: '护国寺小吃、锦芳小吃、天兴居', why: '老北京人最爱的传统饮品，酸香独特，来北京必尝' },
      { name: '酸梅汤', desc: '老北京信远斋酸梅汤/桂花酸梅汤', shops: '信远斋、九龙斋', why: '北京人夏天消暑解渴的传统饮品，酸甜开胃' },
      { name: '北京老酸奶', desc: '瓷瓶老酸奶/蜂蜜酸奶', shops: '三元梅园、文宇奶酪店', why: '北京胡同里的特色饮品' },
      { name: '茶话弄', desc: '长安古法/梅占摇红/桂花引', shops: '茶话弄（王府井/三里屯店）', why: '北京本土人气新式茶饮品牌' }
    ],
    foods: [
      { name: '北京烤鸭', desc: '挂炉烤鸭/焖炉烤鸭/片皮鸭', why: '北京名片级美食，全聚德/大董/四季民福各有特色' },
      { name: '炸酱面', desc: '老北京炸酱面/打卤面', why: '老北京人日常主食，海碗居/方砖厂69号地道' },
      { name: '涮羊肉', desc: '铜锅涮肉/手切鲜羊肉/麻酱', why: '北京冬天必吃，东来顺/南门涮肉百年老字号' },
      { name: '卤煮火烧', desc: '卤煮/小肠陈/炸灌肠', why: '老北京小吃代表' },
      { name: '炒肝', desc: '炒肝/包子', why: '北京传统早点，天兴居/姚记炒肝最出名' }
    ]
  },
  '成都': {
    drinks: [
      { name: '盖碗茶', desc: '茉莉花茶/竹叶青/碧潭飘雪', shops: '人民公园鹤鸣茶社、宽窄巷子见山书局', why: '成都人"泡茶馆"的生活方式，慢生活象征' },
      { name: '酸梅汤', desc: '老成都酸梅汤/冰镇酸梅汤', shops: '双流老妈兔头旁饮品摊、锦里古街', why: '成都人夏天吃火锅必备解辣饮品' },
      { name: '冰粉', desc: '红糖冰粉/糍粑冰粉/水果冰粉', shops: '建设路小吃街、奎星楼街', why: '成都街头消暑甜品，吃完火锅来一碗爽翻' },
      { name: '霸王茶姬', desc: '伯牙绝弦/春日桃桃/花田乌龙', shops: '霸王茶姬（春熙路/太古里店）', why: '成都本土走向全国的茶饮品牌' }
    ],
    foods: [
      { name: '火锅', desc: '牛油火锅/清油火锅/九宫格/毛肚/鸭肠', why: '成都美食名片，小龙坎/大龙燚/蜀大侠都是经典' },
      { name: '串串香', desc: '冷锅串串/热锅串串/钵钵鸡', why: '成都人最爱的市井美食' },
      { name: '担担面', desc: '担担面/甜水面/钟水饺/龙抄手', why: '成都名小吃代表' },
      { name: '麻婆豆腐', desc: '陈麻婆豆腐/回锅肉/夫妻肺片', why: '百年老字号川菜' },
      { name: '兔头', desc: '麻辣兔头/五香兔头', why: '成都人最爱的小吃，双流老妈兔头最出名' }
    ]
  },
  '重庆': {
    drinks: [
      { name: '酸梅汤', desc: '老重庆酸梅汤/桂花酸梅汤', shops: '解放碑好吃街、磁器口古镇', why: '重庆人吃火锅后的解辣神器' },
      { name: '山城酸奶', desc: '天友老酸奶/山城酸奶', shops: '天友乳业专卖店、各大超市', why: '重庆本地老字号乳制品' },
      { name: '冰汤圆', desc: '红糖冰汤圆/醪糟冰汤圆', shops: '八一好吃街、观音桥好吃街', why: '重庆夏天街头消暑甜品' },
      { name: '一只酸奶牛', desc: '招牌酸奶紫米露/草莓酸奶', shops: '一只酸奶牛（解放碑/观音桥店）', why: '重庆本土茶饮品牌，川渝地区人气高' }
    ],
    foods: [
      { name: '重庆火锅', desc: '九宫格牛油火锅/毛肚/鸭肠/黄喉/脑花', why: '重庆美食灵魂，佩姐/周师兄/珮姐都是代表' },
      { name: '重庆小面', desc: '豌杂面/牛肉面/肥肠面', why: '重庆人早餐标配，秦云老太婆摊摊面最有名' },
      { name: '酸辣粉', desc: '手工酸辣粉/杂酱酸辣粉', why: '重庆小吃代表' },
      { name: '江湖菜', desc: '辣子鸡/水煮鱼/毛血旺/烤鱼', why: '重庆人豪爽的饮食文化代表' },
      { name: '豆花饭', desc: '豆花/蘸水/甑子饭', why: '重庆人日常简餐' }
    ]
  },
  '长沙': {
    drinks: [
      { name: '茶颜悦色', desc: '声声乌龙/幽兰拿铁/人间烟火/桂花弄', shops: '茶颜悦色（太平街/黄兴路步行街店）', why: '长沙本土茶饮名片，全国游客来长沙必打卡' },
      { name: '果呀呀', desc: '芒果雪乐/草莓小公主/牛油果奶昔', shops: '果呀呀（五一广场/国金街店）', why: '长沙本土鲜果茶饮品牌' },
      { name: '绿豆沙冰', desc: '冰镇绿豆沙/绿豆沙牛乳', shops: '太平街小吃摊、南门口', why: '长沙人夏天消暑经典饮品' }
    ],
    foods: [
      { name: '臭豆腐', desc: '黑色经典臭豆腐/文和友臭豆腐', why: '长沙小吃名片，外酥里嫩' },
      { name: '口味虾', desc: '麻辣小龙虾/蒜蓉小龙虾', why: '长沙夏天夜宵顶流' },
      { name: '剁椒鱼头', desc: '剁椒鱼头/鱼头泡饼', why: '湘菜经典代表' },
      { name: '米粉', desc: '长沙米粉/扁粉/码子粉', why: '长沙人早餐日常' },
      { name: '糖油粑粑', desc: '糖油粑粑/葱油粑粑', why: '长沙传统小吃' }
    ]
  },
  '上海': {
    drinks: [
      { name: '上海老酸奶', desc: '瓷瓶老酸奶/光明冰砖/绿豆汤', shops: '光明邨、老大昌、沈大成', why: '上海人从小喝到大的老味道' },
      { name: '上海咖啡', desc: '老上海咖啡馆/手冲/拿铁', shops: '老麦咖啡馆、Manner Coffee、永璞咖啡', why: '上海是咖啡之都，街头巷尾都是精品咖啡馆' },
      { name: 'Manner Coffee', desc: '拿铁/澳白/Dirty', shops: 'Manner Coffee（上海各门店）', why: '上海本土走向全国的精品咖啡品牌' }
    ],
    foods: [
      { name: '小笼包', desc: '鲜肉小笼/蟹粉小笼/汤包', why: '上海点心代表，南翔馒头店/佳家汤包经典' },
      { name: '生煎', desc: '鲜肉生煎/大虾生煎', why: '上海早餐灵魂，大壶春/小杨生煎最出名' },
      { name: '本帮菜', desc: '红烧肉/油爆虾/腌笃鲜/八宝鸭', why: '上海家常菜代表，兰心餐厅/老正兴地道' },
      { name: '葱油拌面', desc: '葱油拌面/开洋葱油拌面', why: '上海人的日常简餐' },
      { name: '排骨年糕', desc: '排骨年糕/炸猪排', why: '上海传统小吃' }
    ]
  },
  '杭州': {
    drinks: [
      { name: '西湖龙井', desc: '明前龙井/雨前龙井/龙井绿茶', shops: '龙井村茶农、西湖茶叶市场、湖畔居', why: '中国十大名茶之首，来杭州必品' },
      { name: '桂花酒酿', desc: '桂花酒酿/桂花藕粉', shops: '河坊街、南宋御街', why: '杭州秋季特色饮品' },
      { name: '古茗', desc: '招牌柠檬茶/超A芝士葡萄/厚道椰椰', shops: '古茗（湖滨银泰/武林路店）', why: '浙江本土茶饮品牌' }
    ],
    foods: [
      { name: '西湖醋鱼', desc: '西湖醋鱼/草鱼', why: '杭州名菜，楼外楼/山外山最经典' },
      { name: '东坡肉', desc: '东坡肉/红烧肉', why: '苏东坡流传千年的名菜' },
      { name: '龙井虾仁', desc: '龙井虾仁/清炒虾仁', why: '杭州特色菜，茶香与虾鲜的完美结合' },
      { name: '片儿川', desc: '片儿川/雪菜肉丝面', why: '杭州人日常面食' },
      { name: '葱包桧', desc: '葱包桧/油条/甜面酱', why: '杭州传统小吃' }
    ]
  },
  '西安': {
    drinks: [
      { name: '冰峰汽水', desc: '橙味冰峰/苹果味冰峰', shops: '西安各小卖部/餐厅', why: '西安人从小喝到大的本土汽水，和凉皮肉夹馍是"三秦套餐"' },
      { name: '稠酒', desc: '黄桂稠酒/桂花稠酒', shops: '回民街、西安饭庄', why: '西安传统饮品，酸甜可口，西安人过年必喝' },
      { name: '茶话弄', desc: '长安古法/梅占摇红/桂花引', shops: '茶话弄（大唐不夜城/钟楼店）', why: '西安本土茶饮品牌，大唐文化主题' }
    ],
    foods: [
      { name: '羊肉泡馍', desc: '牛羊肉泡馍/小炒泡馍', why: '西安美食名片，同盛祥/老孙家百年老字号' },
      { name: '肉夹馍', desc: '腊汁肉夹馍/潼关肉夹馍', why: '西安人从小吃到大的早餐' },
      { name: '凉皮', desc: '米皮/面皮/擀面皮/麻将凉皮', why: '西安夏天必吃' },
      { name: 'Biangbiang面', desc: '油泼面/Biangbiang面/裤带面', why: '陕西面食代表' },
      { name: '葫芦鸡', desc: '葫芦鸡/温拌腰丝', why: '陕菜经典代表' }
    ]
  },
  '桂林': {
    drinks: [
      { name: '桂林三花酒', desc: '桂林三花酒/桂花酒', shops: '桂林特产店、阳朔西街', why: '桂林传统米香型白酒，当地人佐餐最爱' },
      { name: '桂花茶', desc: '桂花乌龙/桂花绿茶', shops: '桂林特产店、阳朔西街', why: '桂林特产桂花制成的香茶' },
      { name: '萃茶师', desc: '招牌奶茶/芝士果茶', shops: '萃茶师（桂林各门店）', why: '广西本土茶饮品牌' }
    ],
    foods: [
      { name: '桂林米粉', desc: '卤菜粉/汤粉/牛腩粉/锅烧', why: '桂林美食灵魂，崇善米粉/日头火米粉最地道' },
      { name: '啤酒鱼', desc: '阳朔啤酒鱼/剑骨鱼', why: '阳朔招牌菜，谢三姐/大师傅最有名' },
      { name: '田螺酿', desc: '田螺酿/豆腐酿/辣椒酿', why: '桂林特色酿菜' },
      { name: '荔浦芋扣肉', desc: '荔浦芋头/扣肉', why: '桂林传统名菜' },
      { name: '马蹄糕', desc: '马蹄糕/桂花糕', why: '桂林传统小吃' }
    ]
  },
  '南宁': {
    drinks: [
      { name: '槐花粉', desc: '槐花粉/红糖槐花粉', shops: '南宁街头小吃摊、中山路夜市', why: '南宁人夏天消暑传统饮品' },
      { name: '甘蔗汁', desc: '鲜榨甘蔗汁/柠檬甘蔗汁', shops: '南宁街头榨汁摊、建政路夜市', why: '广西甘蔗之乡，街头鲜榨甘蔗汁随处可见' },
      { name: '阿嬷手作', desc: '招牌米麻薯/龙眼桂花冰/桃胶奶茶', shops: '阿嬷手作（南宁万象城/朝阳广场店）', why: '广西本土茶饮品牌，现熬手作' }
    ],
    foods: [
      { name: '老友粉', desc: '老友粉/猪杂老友/牛肉老友', why: '南宁美食名片，邕味老友/复记老友最地道' },
      { name: '柠檬鸭', desc: '柠檬鸭/酸梅鸭', why: '南宁特色菜' },
      { name: '卷筒粉', desc: '卷筒粉/肉末豆角卷筒粉', why: '南宁人早餐日常' },
      { name: '酸嘢', desc: '酸嘢/芒果酸/萝卜酸', why: '南宁街头小吃' },
      { name: '八宝饭', desc: '八宝饭/糯米甜饭', why: '南宁传统甜品' }
    ]
  },
  '深圳': {
    drinks: [
      { name: '椰子鸡配椰子水', desc: '新鲜椰子水/椰青', shops: '同仁四季椰子鸡、润园四季', why: '深圳人吃椰子鸡必配的天然饮品' },
      { name: '奈雪的茶', desc: '霸气芝士草莓/霸气橙子/杨枝甘露', shops: '奈雪的茶（深圳各门店）', why: '深圳本土走向全国的茶饮品牌' },
      { name: '喜茶', desc: '多肉葡萄/芝芝莓莓/满杯红柚', shops: '喜茶（深圳各门店）', why: '深圳本土茶饮品牌，新式茶饮开创者' }
    ],
    foods: [
      { name: '椰子鸡', desc: '文昌椰子鸡/竹笙椰子鸡', why: '深圳美食名片，润园四季/同仁四季最出名' },
      { name: '海鲜', desc: '生蚝/花蟹/皮皮虾/海胆', why: '深圳沿海城市，海鲜丰富' },
      { name: '猪脚饭', desc: '隆江猪脚饭/猪肘饭', why: '深圳打工人的日常简餐' },
      { name: '砂锅粥', desc: '虾蟹粥/鲜虾粥/田鸡粥', why: '深圳人夜宵首选' },
      { name: '茶餐厅', desc: '菠萝油/丝袜奶茶/叉烧饭', why: '深圳港式茶餐厅文化' }
    ]
  },
  '武汉': {
    drinks: [
      { name: '蛋酒', desc: '鸡蛋米酒/桂花蛋酒', shops: '武汉各早餐摊、户部巷', why: '武汉人过早必配的热饮，暖胃驱寒' },
      { name: '绿豆汤', desc: '冰镇绿豆汤/百合绿豆汤', shops: '武汉街头各饮品摊', why: '武汉夏天消暑必备"续命水"' },
      { name: '爷爷泡的茶', desc: '招牌奶茶/芝士果茶', shops: '爷爷泡的茶（武汉各门店）', why: '武汉本土茶饮品牌，以武汉方言文化为特色' }
    ],
    foods: [
      { name: '热干面', desc: '芝麻酱热干面/牛肉热干面', why: '武汉美食名片，蔡林记/赵师傅天天红油热干面' },
      { name: '武昌鱼', desc: '清蒸武昌鱼/红烧武昌鱼', why: '毛主席"才饮长沙水，又食武昌鱼"名扬天下' },
      { name: '鸭脖', desc: '周黑鸭/精武鸭脖/绝味鸭脖', why: '武汉休闲零食名片' },
      { name: '豆皮', desc: '三鲜豆皮/牛肉豆皮', why: '武汉人过早代表' },
      { name: '面窝', desc: '面窝/苕面窝/油条', why: '武汉传统早餐' }
    ]
  },
  '南京': {
    drinks: [
      { name: '雨花茶', desc: '南京雨花茶/绿茶', shops: '中山陵茶社、夫子庙', why: '南京特产名茶，茶汤碧绿清香' },
      { name: '糖芋苗', desc: '桂花糖芋苗/赤豆元宵', shops: '莲湖糕团店、夫子庙小吃街', why: '南京传统甜品饮品' },
      { name: '拾叁茶', desc: '招牌十三茶/玫瑰清露', shops: '拾叁茶（老门东/新街口店）', why: '南京本土茶饮品牌，以明文化为主题' }
    ],
    foods: [
      { name: '鸭血粉丝汤', desc: '鸭血粉丝汤/鸭肝鸭肠粉丝', why: '南京美食名片，回味/鸭得堡最出名' },
      { name: '盐水鸭', desc: '盐水鸭/桂花鸭/板鸭', why: '南京"鸭都"名不虚传' },
      { name: '小笼包', desc: '鸡汁汤包/蟹黄汤包', why: '南京人早餐最爱' },
      { name: '牛肉锅贴', desc: '牛肉锅贴/煎饺', why: '南京传统小吃' },
      { name: '赤豆元宵', desc: '赤豆元宵/桂花糖芋苗', why: '南京传统甜品' }
    ]
  },
  '昆明': {
    drinks: [
      { name: '普洱茶', desc: '生普/熟普/普洱奶茶', shops: '昆明雄达茶城、云南各大茶庄', why: '云南名片级饮品，来昆明必品' },
      { name: '木瓜水', desc: '玫瑰木瓜水/红糖木瓜水', shops: '昆明老街、南屏步行街', why: '昆明人夏天消暑传统饮品' },
      { name: '霸王茶姬', desc: '伯牙绝弦/春日桃桃/花田乌龙', shops: '霸王茶姬（昆明各门店）', why: '云南本土走向全国的茶饮品牌' }
    ],
    foods: [
      { name: '过桥米线', desc: '过桥米线/菌汤米线', why: '云南美食名片，桥香园/建新园最经典' },
      { name: '汽锅鸡', desc: '汽锅鸡/三七汽锅鸡', why: '云南传统名菜，原汁原味' },
      { name: '野生菌火锅', desc: '松茸/牛肝菌/鸡枞/青头菌', why: '云南夏季必吃' },
      { name: '烧饵块', desc: '烧饵块/烤乳扇', why: '云南街头小吃' },
      { name: '豆花米线', desc: '豆花米线/凉米线', why: '昆明人日常早餐' }
    ]
  },
  '贵阳': {
    drinks: [
      { name: '茅台酒', desc: '贵州茅台/酱香型白酒', shops: '贵州茅台专卖店', why: '中国国酒，贵州名片' },
      { name: '刺梨汁', desc: '鲜榨刺梨汁/刺梨原浆', shops: '贵阳各超市、特产店', why: '贵州特产水果，维C含量极高' },
      { name: '宜北町', desc: '招牌奶茶/茉莉奶绿', shops: '宜北町（贵阳各门店）', why: '贵州本土茶饮品牌' }
    ],
    foods: [
      { name: '酸汤鱼', desc: '凯里酸汤鱼/红酸汤/白酸汤', why: '贵州美食名片，酸辣开胃' },
      { name: '花溪牛肉粉', desc: '花溪牛肉粉/牛杂粉', why: '贵阳人早餐日常' },
      { name: '肠旺面', desc: '肠旺面/血旺面', why: '贵阳传统小吃' },
      { name: '丝娃娃', desc: '丝娃娃/春卷', why: '贵阳街头小吃' },
      { name: '烙锅', desc: '烙锅/铁板烧', why: '贵阳人夜宵首选' }
    ]
  },
  '南昌': {
    drinks: [
      { name: '瓦罐汤', desc: '墨鱼汤/排骨汤/鸡汤/肉饼汤', shops: '民间饭庄、绳金塔瓦罐汤', why: '南昌人每餐必配的汤品，瓦罐煨制数小时' },
      { name: '洪都大拇指', desc: '招牌奶茶/烧仙草/柠檬茶', shops: '洪都大拇指（南昌各门店）', why: '南昌本土茶饮品牌，性价比高' },
      { name: '凉粉', desc: '南昌凉粉/冰粉', shops: '南昌街头小吃摊', why: '南昌人夏天消暑饮品' }
    ],
    foods: [
      { name: '南昌拌粉', desc: '南昌拌粉/牛肉拌粉/猪肚拌粉', why: '南昌美食名片，周真真/万方圆最出名' },
      { name: '瓦罐汤', desc: '墨鱼汤/排骨汤/鸡汤/肉饼汤', why: '南昌人每餐必配，瓦罐煨制数小时' },
      { name: '藜蒿炒腊肉', desc: '藜蒿炒腊肉/鄱阳湖藜蒿', why: '南昌人过年必吃菜' },
      { name: '白糖糕', desc: '白糖糕/桂花糕', why: '南昌传统小吃' },
      { name: '米粉蒸肉', desc: '米粉蒸肉/粉蒸排骨', why: '南昌家常菜代表' }
    ]
  },
  '福州': {
    drinks: [
      { name: '茉莉花茶', desc: '福州茉莉花茶/茉莉龙珠', shops: '福州茉莉花茶专卖店、三坊七巷', why: '福州特产，茉莉花茶发源地，花香浓郁' },
      { name: '花生汤', desc: '福州花生汤/花生糊', shops: '福州各甜品店、老福州', why: '福州人传统甜品饮品' },
      { name: '壶见', desc: '招牌闽式奶茶/石花膏', shops: '壶见（三坊七巷/东街口店）', why: '福州本土茶饮品牌，闽南文化元素' }
    ],
    foods: [
      { name: '佛跳墙', desc: '鲍鱼/海参/花胶/干贝/鸽子蛋', why: '福州名片级名菜，聚春园最正宗' },
      { name: '鱼丸', desc: '福州鱼丸/肉燕/鱼滑', why: '福州人从小吃到大的小吃' },
      { name: '荔枝肉', desc: '荔枝肉/糖醋肉', why: '福州传统家常菜' },
      { name: '锅边糊', desc: '锅边糊/海蛎饼', why: '福州人早餐日常' },
      { name: '芋泥', desc: '福州芋泥/八宝芋泥', why: '福州传统甜品' }
    ]
  },
  '厦门': {
    drinks: [
      { name: '沙茶汤底', desc: '沙茶面配汤/花生汤', shops: '厦门各沙茶面店', why: '厦门人吃沙茶面必喝汤底' },
      { name: '花生汤', desc: '厦门花生汤/花生奶', shops: '黄则和花生汤、思北花生汤', why: '厦门人从小喝到大的传统饮品' },
      { name: '快乐番薯', desc: '招牌奶茶/番薯拿铁', shops: '快乐番薯（厦门各门店）', why: '厦门本土茶饮品牌' }
    ],
    foods: [
      { name: '沙茶面', desc: '沙茶面/猪肝/鱿鱼/虾仁', why: '厦门美食名片，月华沙茶面/乌糖沙茶面最出名' },
      { name: '土笋冻', desc: '土笋冻/章鱼/海蜇', why: '厦门特色小吃' },
      { name: '姜母鸭', desc: '姜母鸭/麻油鸡', why: '厦门传统名菜' },
      { name: '海蛎煎', desc: '海蛎煎/蚵仔煎', why: '闽南经典小吃' },
      { name: '烧肉粽', desc: '烧肉粽/蛋黄肉粽', why: '厦门传统小吃' }
    ]
  },
  '河源': {
    drinks: [
      { name: '八刀汤', desc: '八刀汤/猪杂汤/枸杞叶猪肝汤', shops: '河源八刀汤老店（老城区）', why: '河源客家名汤，猪杂八种不同部位煮成清汤，鲜美无比' },
      { name: '客家酿酒', desc: '客家娘酒/糯米酒/黄酒', shops: '河源特产店、客家菜馆', why: '客家传统自酿米酒，甜醇可口' },
      { name: '霸王茶姬', desc: '伯牙绝弦/春日桃桃', shops: '霸王茶姬（河源万隆城店）', why: '当地人气茶饮品牌' }
    ],
    foods: [
      { name: '八刀汤', desc: '八刀汤/猪杂汤/枸杞叶猪肝汤', why: '河源美食名片，客家传统名汤' },
      { name: '客家酿豆腐', desc: '酿豆腐/酿苦瓜/酿茄子', why: '客家"无酿不成宴"代表' },
      { name: '盐焗鸡', desc: '东江盐焗鸡/手撕鸡', why: '客家经典菜' },
      { name: '梅菜扣肉', desc: '梅菜扣肉/客家扣肉', why: '客家传统名菜' },
      { name: '萝卜粄', desc: '萝卜粄/艾粄/糍粑', why: '河源传统小吃' }
    ]
  },
  '佛山': {
    drinks: [
      { name: '顺德双皮奶', desc: '双皮奶/姜撞奶/水牛奶', shops: '民信老铺、仁信老铺、金榜牛奶店', why: '顺德美食名片，水牛奶制成，奶香浓郁' },
      { name: '广式凉茶', desc: '癍痧/廿四味/五花茶', shops: '黄振龙凉茶、邓老凉茶', why: '广府人日常饮品' },
      { name: '茶理宜世', desc: '招牌江南烟雨/月下桂花酿', shops: '茶理宜世（佛山岭南天地店）', why: '佛山年轻人喜爱的茶饮品牌' }
    ],
    foods: [
      { name: '顺德鱼生', desc: '顺德鱼生/菊花鱼生/捞起鱼生', why: '顺德美食灵魂，世界美食之都代表菜' },
      { name: '双皮奶', desc: '顺德双皮奶/姜撞奶', why: '顺德甜品名片' },
      { name: '烧鹅', desc: '顺德烧鹅/荔枝柴烧鹅', why: '佛山人待客硬菜' },
      { name: '陈村粉', desc: '陈村粉/排骨蒸陈村粉', why: '佛山传统小吃' },
      { name: '扎蹄', desc: '佛山扎蹄/酝扎蹄', why: '佛山传统名菜' }
    ]
  },
  '东莞': {
    drinks: [
      { name: '茅根竹蔗水', desc: '茅根竹蔗水/马蹄竹蔗水', shops: '东莞各凉茶铺、老字号', why: '东莞人夏天消暑传统饮品，清甜解渴' },
      { name: '广式凉茶', desc: '癍痧/廿四味/五花茶', shops: '黄振龙凉茶、邓老凉茶', why: '东莞人日常必备' },
      { name: '茶理宜世', desc: '招牌江南烟雨/月下桂花酿', shops: '茶理宜世（东莞国贸/汇一城店）', why: '东莞年轻人最爱的茶饮品牌' }
    ],
    foods: [
      { name: '烧鹅濑粉', desc: '烧鹅濑粉/烧鹅饭', why: '东莞美食名片，厚街烧鹅濑最出名' },
      { name: '白沙油鸭', desc: '白沙油鸭/腊鸭', why: '东莞传统名产' },
      { name: '道滘肉丸', desc: '道滘肉丸/粥', why: '东莞传统小吃' },
      { name: '冼沙鱼丸', desc: '冼沙鱼丸/鱼丸汤', why: '东莞特色小吃' },
      { name: '糖不甩', desc: '糖不甩/糯米团', why: '东莞传统甜品' }
    ]
  },
  '顺德': {
    drinks: [
      { name: '顺德双皮奶', desc: '双皮奶/姜撞奶/水牛奶', shops: '民信老铺、仁信老铺、金榜牛奶店', why: '世界美食之都顺德甜品名片，水牛奶制成' },
      { name: '广式糖水', desc: '杨枝甘露/椰汁西米露/绿豆沙', shops: '仁信老铺、民信老铺', why: '顺德人夏天必喝消暑甜品' },
      { name: '广式凉茶', desc: '癍痧/廿四味/五花茶', shops: '黄振龙凉茶', why: '广府人日常饮品' }
    ],
    foods: [
      { name: '顺德鱼生', desc: '顺德鱼生/菊花鱼生/捞起鱼生', why: '世界美食之都顺德代表菜，刀工精湛' },
      { name: '双皮奶', desc: '顺德双皮奶/姜撞奶', why: '顺德甜品名片' },
      { name: '烧鹅', desc: '顺德烧鹅/荔枝柴烧鹅', why: '顺德人待客硬菜' },
      { name: '陈村粉', desc: '陈村粉/排骨蒸陈村粉', why: '顺德传统小吃' },
      { name: '煲仔饭', desc: '腊味煲仔饭/黄鳝煲仔饭', why: '顺德传统美食' }
    ]
  },
  '成都': {
    drinks: [
  ...
  "overall_reason": "整体设计思路（1-2 句）"
    ...
    let localSpecials = null;
    {
      ...
      think(4.65, '当地特色饮品 & 美食', localSpecials.has_data ? 'success' : 'fallback', {
        ...
        drinks: drinkList,
        foods: foodList,
        note: localSpecials.note || '数据来自本地知识库，全部为真实可查的当地特色饮品和美食'
